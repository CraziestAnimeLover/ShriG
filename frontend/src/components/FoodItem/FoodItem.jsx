...
const FoodItem = ({ image, name, price, desc, id }) => {
  ...
  return (
    <div
      className="w-full mx-auto rounded-[15px] shadow-[0_0_10px_rgba(0,0,0,0.09)] transition-transform duration-300 animate-fadeIn hover:scale-[1.02]"
    >
      {/* Image Container */}
      <div className="relative">
        ...
        {!cartItems[id] ? (
          ...
          <div
            className="absolute bottom-[15px] right-[15px] flex items-center gap-[10px] p-[6px] rounded-full bg-white"
          >
            <img
            ...
            />
            <p className="font-medium text-gray-800">{cartItems[id]}</p>
            <img
